            ...
            <div className="p-10 border-b border-white/5 flex justify-between items-start bg-surface-lowest/20">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  {subtitle && (
                    <span className="text-[9px] text-on-surface-variant font-bold uppercase tracking-[0.2em]">
                      {subtitle}
                    </span>
                  )}
                </div>
                <h2 className="font-manrope font-black text-3xl tracking-tight leading-none group hover:text-primary-emerald transition-colors">
                  {title}
                </h2>
              </div>
                ...
                {allowEdit && (
                  <button
                    ...
                    className={cn(
                      ...
                      isEditing
                        ? "bg-primary-emerald text-surface-container border-primary-emerald shadow-premium"
                        : "bg-surface-lowest text-on-surface-variant border-white/5 hover:text-foreground hover:bg-surface-high",
                    )}
                  >
                    <Edit3 size={20} />
                  </button>
              ...
              {isEditing ? (
                ...
                <>
                  <button className="flex-1 py-4 bg-surface-lowest text-on-surface-variant font-black text-[10px] uppercase tracking-widest rounded-2xl border border-white/5 hover:bg-surface-high hover:text-foreground flex items-center justify-center gap-3 group transition-all">
                    <ExternalLink
                      size={16}
                      className="group-hover:text-primary-emerald"
                    />{" "}
                    Master Audit Report
                  </button>
                  <button
