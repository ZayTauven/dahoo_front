  ...
  return (
    <Shell>
      <section className="flex justify-between items-end mb-10">
        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-end">
            ...
            <span className="text-sm font-manrope font-extrabold text-foreground">
              April 12, 2026
            </span>
          </div>
              ...
              <div className="w-full h-2 bg-surface-lowest rounded-full overflow-hidden p-0.5">
                <div
                  className={cn(
                    ...
                    telemetry.color.replace("text-", "bg-"),
                  )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <Surface
          level="low"
          className="lg:col-span-8 p-8 relative overflow-hidden h-500px flex flex-col border border-white/5"
        >
          <div className="flex justify-between items-start mb-8 z-10">
            <div>
              <h2 className="text-2xl font-manrope font-extrabold tracking-tight">
                System Node Consumption
              </h2>
              <p className="text-xs text-on-surface-variant uppercase tracking-widest mt-1">
                Cross-regional API Load Vector
              </p>
            </div>
            <div className="flex items-center gap-4">
          ...
          <div className="mt-8 flex gap-8 z-10 pt-6 border-t border-white/5">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-surface-highest text-secondary-gold">
                <RefreshCw size={14} />
              </div>
              <div>
                ...
                <p className="text-sm font-extrabold uppercase tracking-widest text-secondary-gold">
                  READY
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-surface-highest text-primary-emerald">
                <Globe size={14} />
              </div>
              <div>
                <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">
                ...
                <p className="text-sm font-extrabold uppercase tracking-widest text-primary-emerald">
                  OPTIMAL
                </p>
              </div>
            </div>
        ...
        <Surface
          level="bright"
          className="lg:col-span-4 p-8 flex flex-col border border-white/5 no-line"
        >
          <div className="flex items-center gap-3 mb-8">
            <div className="p-2.5 rounded-xl bg-primary-emerald/10 text-primary-emerald">
              <Cpu size={20} />
            </div>
            <h3 className="font-manrope font-extrabold text-xl">
              Global Hub Status
            </h3>
          </div>
          ...
          <div className="space-y-6 flex-1 pr-2 custom-scrollbar">
            {[
              ...
              <div
                key={i}
                className="flex justify-between items-center border-b border-surface-bright pb-4 last:border-0 hover:translate-x-1 transition-transform cursor-pointer group"
              >
                <div className="flex items-center gap-3">
                  <div
                    className={cn(
                  ...
                  />
                  <div>
                    <p className="text-xs font-extrabold group-hover:text-primary-emerald transition-colors">
                      {node.hub}
                    </p>
                    <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">
                      {node.load} Load Pulse
                    </p>
                  </div>
                </div>
                <div className="text-right">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10 relative z-10">
          <div className="max-w-xl">
            ...
            <h2 className="text-4xl font-manrope font-extrabold tracking-tight leading-tight">
              Empowering Global Real Estate with{" "}
              <span className="text-secondary-gold">Dahoo Intelligence.</span>
            </h2>
            <p className="text-sm text-on-surface-variant mt-4 leading-relaxed italic opacity-80">
              You are currently utilizing the Pro-Elite license, with
              architectural node optimization enabled for all regional clusters.
            </p>
          </div>
          <div className="flex flex-col gap-4 min-w-64">
            <div className="flex items-center gap-3 p-4 bg-surface-lowest rounded-2xl border border-white/5">
              ...
              <div>
                <p className="text-[10px] font-extrabold text-on-surface-variant uppercase">
                  Data Sovereignty
                </p>
